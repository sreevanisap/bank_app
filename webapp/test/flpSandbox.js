		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Bank App",
									"targetURL": "#comsapbankapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapbankapp-display": {
								"semanticObject": "comsapbankapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.bankapp",
									"url": sap.ui.require.toUrl("com/sap/bankapp")
								}
							}
						}
					}
